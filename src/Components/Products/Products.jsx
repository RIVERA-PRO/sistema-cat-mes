                ...
                <div className={`categoriasInputs ${fixedCategories ? 'fixed' : ''}`} id='FlexIn' ref={categoriasInputRef}>
                    <div className='categoriasInputsFilter' >
                        <input
                            ...
                            style={{
                                backgroundColor: categoriaSeleccionada === 'Todo' ? '#141618' : '',
                        ...
                        {categoriasConProductos?.map(({ categoria, idCategoria }) => (
                            <div className='columnInput' key={idCategoria}>
                                <input
                                    ...
                                    style={{
                                        backgroundColor: categoriaSeleccionada === idCategoria ? '#141618' : '',
                        ...
                        subcategorias?.filter(subcategoria =>
                            ...
                            <div className='categoriasInputsFilter' id='subcategoriasInputs'>
                                <input
                                    ...
                                    style={{
                                        borderBottom: subcategoriaSeleccionada === 'Todo' ? '2px solid #141618' : '',
                                        color: subcategoriaSeleccionada === 'Todo' ? '#141618' : '',
                                    }}
                                    ...
                                    ?.map(subcategoria => (
                                        <div key={subcategoria.idSubCategoria}>
                                            <input
                                                ...
                                                style={{
                                                    borderBottom: subcategoriaSeleccionada === subcategoria.idSubCategoria ? '2px solid #141618' : '',
                                                    color: subcategoriaSeleccionada === subcategoria.idSubCategoria ? '#141618' : '',
                                                }}
                                                id='subcategoriaInput'
